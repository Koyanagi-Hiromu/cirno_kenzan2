...
public class Wiki_First_Commnad_View extends Base_Scene_Menu_View {

	public Wiki_First_Commnad_View(Base_View bv) {
		super(Scene_Menu_First_Item_List_View.X
				+ Scene_Menu_First_Item_List_View.MAIN_W
				+ Scene_Menu_First_Item_List_View.MARGINE, 36 - 9,
