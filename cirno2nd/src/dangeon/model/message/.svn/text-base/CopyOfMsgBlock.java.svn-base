...
public class CopyOfMsgBlock {
	...
	// if (diff >= DIFF) {
	// MessageRecord.endTask();
	// }
	// } else {
	// last_message_time += Frame.THREAD_SLEEP;
	// }
	// }
	// }
	// }
	...
	// return true;
	// } else {
	// int duration = (MessageRecord.isNextTaskEmpty()) ? LAST_MESSAGE_DURATION
	// : BLOCK_DURATION;
	...
	// * @param array
	// */
	// CopyOfMsgBlock(Image_LargeCharacter ilc, ArrayList<String> arr) {
	...
	// int sleep = 0;
	//
	// public CopyOfMsgBlock(Image_LargeCharacter ilc, ArrayList<String> arr,
	// int sleep) {
	// this(ilc, arr);
