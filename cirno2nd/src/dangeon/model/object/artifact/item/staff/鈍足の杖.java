 ...
 * 
 */
public class 鈍足の杖 extends Staff {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
	public static final ITEM_CASE item_case = ITEM_CASE.STAFF;
	public static final String item_name = "鈍足の杖";
	public static final String item_name_sound = "とんそくのつえ";
	...
	protected String getSecondExplain_ByEach() {
		return "鈍足になった敵は２ターンに１度しか動けなくなる。左下にマークが出ている次のターンに行動する。";
	}
