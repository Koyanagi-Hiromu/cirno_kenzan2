 ...
 * 
 */
public class 影縛りの杖 extends Staff {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
	public static final ITEM_CASE item_case = ITEM_CASE.STAFF;
	public static final String item_name = "影縛りの杖";
	public static final String item_name_sound = "かけしはりのつえ";

	public 影縛りの杖(Point p) {
		super(p, item_name, 1);
	}
	...
	protected void effect(Base_Creature c) {
		...
		c.setCondition(CONDITION.影縫い, t);
	}
