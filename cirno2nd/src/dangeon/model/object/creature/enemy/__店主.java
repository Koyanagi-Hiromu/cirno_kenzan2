...
public abstract class __店主 extends Base_Enemy {
	...
	public __店主(Point p, int lv) {
		super(p, lv);
		this.shop = null;
	}

	public __店主(Point p, int lv, Shop shop, Image_LargeCharacter imlc) {
		super(p, lv);
		this.shop = shop;
		IMLC = imlc;
	}
	...
	private void pleasePages(String s) {
		final ArrayList<Base_Item> list = new ArrayList<Base_Item>();
		int sum = 0;
